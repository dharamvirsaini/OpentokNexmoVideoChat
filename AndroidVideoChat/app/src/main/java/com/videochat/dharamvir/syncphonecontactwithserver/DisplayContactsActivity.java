...
public class DisplayContactsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((ImageView) findViewById(R.id.share_call)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent in = new Intent(DisplayContactsActivity.this, OngoingCallActivity.class);

                in.putExtra("web", true);
            ...
            public void onClick(View v) {
                ...
                if (mSelectView.getText().equals("Select")) {
                   ...
                   // DisplayContactsActivity.this.findViewById(R.id.button2).setVisibility(View.VISIBLE);
                    ...
                    DisplayContactsActivity.this.findViewById(R.id.add_contact).setVisibility(View.VISIBLE);
                    DisplayContactsActivity.this.findViewById(R.id.chats_text).setVisibility(View.VISIBLE);
                    DisplayContactsActivity.this.findViewById(R.id.share_call).setVisibility(View.VISIBLE);
    ...
    private void checkUpdateVersion(final Context context){
        ...
        if (jsonObject.has("meet_versionCode")){
            ...
            try {
                ...
                versionOnPlayStore = Integer.parseInt(jsonObject.getString("meet_versionCode"));
...
// Retrieve number array from JSON object.
        ...
        protected void onPostExecute(ArrayList<ContactInfo> s) {
            ...
            if (s == null) {
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(DisplayContactsActivity.this);
