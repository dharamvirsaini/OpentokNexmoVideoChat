...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ContactViewHolder> {
    ...
    public class ContactViewHolder extends RecyclerView.ViewHolder implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            ...
            if (mContext.mSelectView.getText().equals("Select")) {
                mContext.mSelectView.setText("Cancel");
                mContext.mSelectView.setVisibility(View.VISIBLE);
                mContext.findViewById(R.id.add_contact).setVisibility(View.GONE);
                mContext.findViewById(R.id.chats_text).setVisibility(View.GONE);
                mContext.findViewById(R.id.share_call).setVisibility(View.GONE);
            } else {
                mContext.findViewById(R.id.button2).setVisibility(View.VISIBLE);
                RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)mContext.findViewById(R.id.add_contact_below).getLayoutParams();
                params.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
                ...
                mContext.findViewById(R.id.button2).setVisibility(View.GONE);
                mContext.findViewById(R.id.add_contact).setVisibility(View.VISIBLE);
                mContext.findViewById(R.id.chats_text).setVisibility(View.VISIBLE);
                mContext.findViewById(R.id.share_call).setVisibility(View.VISIBLE);
                mContext.mSelectView.setVisibility(View.GONE);
                mContext.mSelectView.setText("Select");
            }
